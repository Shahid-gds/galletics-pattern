...
const cards = ref([
    {
        ...
        heading: 'Orange Calcite', stars: import('../components/icons/star.svg').then((module) => module.default),
        amount: '$47.00',
        cardButton: 'Shop Now',
    },
    {
        image: import('../assets/images/GreenSardonyx.svg').then((module) => module.default),
        heading: 'Green Sardonyx', stars: import('../components/icons/star.svg').then((module) => module.default),
        amount: '$55.00',
        cardButton: 'Shop Now'
    },

    {
        ...
        heading: 'Red Jasper', stars: import('../components/icons/star.svg').then((module) => module.default),
        amount: '$38.00',
        cardButton: 'Shop Now'
    },
