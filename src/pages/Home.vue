...
const sections = [
  ...
  { name: 'AboutUsBg', class: 'AboutUsBg', component: defineAsyncComponent(() => import('../views/AboutUsSection.vue').then(m => m.default), { lazy: true }) },
  { name: 'ChooseBg', class: 'ChooseBg', component: defineAsyncComponent(() => import('../views/ChooseSection.vue').then(m => m.default), { lazy: true }) },
