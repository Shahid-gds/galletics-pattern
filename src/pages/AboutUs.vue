<template>
   ...
   const sections = [
     ...
     { name: 'AboutUsBg', class: 'AboutUsBg', component: defineAsyncComponent(() => import('../views/AboutAcvanceAstrology.vue').then(m => m.default), { lazy: true }) },
     { name: 'ChooseBg', class: 'ChooseBg', component: defineAsyncComponent(() => import('../views/AboutUsEbookSection.vue').then(m => m.default), { lazy: true }) },
