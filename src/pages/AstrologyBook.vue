<template>
   ...
   const sections = [
     { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/AstrologyBookDetail.vue').then(m => m.default), { lazy: true }) },
     { name: 'RelatedProductBg', class: 'RelatedProductBg', component: defineAsyncComponent(() => import('../views/PalmistryBookRelatedProduct.vue').then(m => m.default), { lazy: true }) },
   ];
   setTimeout(() => {
