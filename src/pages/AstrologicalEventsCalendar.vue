<template>
  ...
  import { ref, defineAsyncComponent, onMounted, onUnmounted } from 'vue';
   ...
   <style scoped>
   .HomeHeroBg{
    background: url("@/assets/images/bgs/AstrologicalEventsHeroBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
    background-size: cover;
   }
   .AboutUsBg{
    background: url("@/assets/images/bgs/EventCarouselBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
