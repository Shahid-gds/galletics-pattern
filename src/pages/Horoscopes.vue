<template>
   ...
   const sections = [
     { name: 'HoroscopesHeroBg', class: 'HoroscopesHeroBg', component: defineAsyncComponent(() => import('../views/HoroscopesHeroSection.vue').then(m => m.default), { lazy: true }) },
     { name: 'HoroscopesAboutBg', class: 'HoroscopesAboutBg', component: defineAsyncComponent(() => import('../views/HoroscopesAboutSection.vue').then(m => m.default), { lazy: true }) },
   ...
   <style scoped>
   .HoroscopesHeroBg{
    background: url("@/assets/images/bgs/HoroscopesHeroBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
    background-size: cover;
   }
   .HoroscopesAboutBg{
    background: url("@/assets/images/bgs/HoroscopesAboutBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
    background-size: cover;
   }
   .ChooseBg{
