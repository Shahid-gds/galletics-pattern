<template>
   ...
   const sections = [
     { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/LearningHubResourcesHeroSection.vue').then(m => m.default), { lazy: true }) },
     { name: 'AboutUsBg', class: 'AboutUsBg', component: defineAsyncComponent(() => import('../views/IntroAstrologySection.vue').then(m => m.default), { lazy: true }) },
     { name: 'ChooseBg', class: 'ChooseBg', component: defineAsyncComponent(() => import('../views/EbookSection.vue').then(m => m.default), { lazy: true }) },
   ...
   <style scoped>
   .HomeHeroBg{
    background: url("@/assets/images/bgs/LearningHubHeroBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
