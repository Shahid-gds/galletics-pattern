<template>
    <div>
     ...
     <section :class="{ 'bg-opacity-100': !isLoading }" class="bg bg-gradient-to-t from-[#140428] bg-[#140428] transition-opacity duration-500">
   ...
   const sections = [
     { name: 'LoveCompatibilityHeroBg', class: 'LoveCompatibilityHeroBg', component: defineAsyncComponent(() => import('../views/Love&CompatibilityHeroSection.vue').then(m => m.default), { lazy: true }) },
     { name: 'AboutUsBg', class: 'AboutUsBg', component: defineAsyncComponent(() => import('../views/Love&CompatibilityAbout.vue').then(m => m.default), { lazy: true }) },
     { name: 'ChooseBg', class: 'ChooseBg', component: defineAsyncComponent(() => import('../views/YearlyZodiac.vue').then(m => m.default), { lazy: true }) },
   ...
   <style scoped>
   .LoveCompatibilityHeroBg
    {
    background: url("@/assets/images/bgs/Love&CompatibilityHeroBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
